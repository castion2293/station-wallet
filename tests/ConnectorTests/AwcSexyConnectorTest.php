...
class AwcSexyConnectorTest extends BaseTestCase
{
    /**
     * 遊戲館連結器
     *
    ...
    /**
     * 測試使用 connector 建立「性感百家」遊戲帳號
     *
     * @throws \Exception
     */
    public function testBuildAwcSexyGameAccount()
    {
        try {
            // 顯示測試案例描述
            $this->console->writeln('測試使用 connector 建立「性感百家」遊戲帳號');
    ...
    /**
     * 測試使用 connector 取得「性感百家」遊戲餘額
     *
     * @throws \Exception
     */
    public function testGetAwcSexyBalance()
    {
        try {
            // 顯示測試案例描述
            $this->console->writeln('測試使用 connector 取得「性感百家」遊戲餘額');
    ...
    /**
     * 測試使用 connector 增加「性感百家」遊戲餘額
     *
     * @throws \Exception
     */
    public function testAddAwcSexyBalance()
    {
        try {
            // 顯示測試案例描述
            $this->console->writeln('測試使用 connector 增加「性感百家」遊戲餘額');
    ...
    /**
     * 測試使用 connector 回收「性感百家」遊戲餘額
     *
     * @throws \Exception
     */
    public function testReduceAwcSexyBalance()
    {
        try {
            // 顯示測試案例描述
            $this->console->writeln('測試使用 connector 回收「性感百家」遊戲餘額');
    ...
    public function testAdjustBalance()
    {
        try {
            // 顯示測試案例描述
            $this->console->writeln('測試使用 connector 調整「性感百家」遊戲餘額');
